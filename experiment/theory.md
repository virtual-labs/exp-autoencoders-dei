...
![Figure 1- Denoising autoencoder](images/image4.png)
...
*   **Input:** ![](images/image1.png) where **n** is random noise
*   **Target:** ![](images/image2.png) (clean image)
...
![Figure 2- Reconstructed Image After Noise Removal](images/image5.png)
